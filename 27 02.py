#2
A = int(input("Введите значение A ")) #1-ое значение
B = int(input("Введите значение B ")) #2-ое значение
C = int(input("Введите значение C ")) #3-е значение
D = A * (B / 3.14) + (C * 3 + 5)
print("A * (B / 3.14) + (C * 3 + 5) = ", D) #Ответ

#1.1 
my_dict = {}
my_dict["surname"] = "Zayneev"
